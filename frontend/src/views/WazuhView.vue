...
<template>
  <div class="p-4 lg:p-6 relative z-10 font-sans h-full overflow-y-auto custom-scrollbar">
    ...
    <Teleport to="body">
      <div v-if="selectedAgent" class="fixed inset-0 z-[300] bg-black/70 flex justify-end" @click.self="selectedAgent = null">
      ...
      <div v-if="selectedAlert" class="fixed inset-0 z-[300] bg-black/70 flex justify-end" @click.self="selectedAlert = null">
